...
test('[default-store/store/composables] useCell', async () => {
  const Component = defineComponent({
    setup() {
      const isValueVisible = ref(false)
      const currentRowId = ref('p1')
      const value = useCell('projects', currentRowId, 'name')
...
test('[default-store/store/composables] useCellIds', () => {
  const Component = defineComponent({
    setup() {
      const cellIds = useCellIds('projects', 'p1')
...
test('[default-store/store/composables] useHasCell', () => {
  const Component = defineComponent({
    setup() {
      const hasCell = useHasCell('projects', 'p1', 'name')
...
test('[default-store/store/composables] useHasRow', () => {
  const Component = defineComponent({
    setup() {
      const hasRow = useHasRow('projects', 'p1')
...
test('[default-store/store/composables] useHasTable', () => {
  const Component = defineComponent({
    setup() {
      const hasTable = useHasTable('projects')
...
test('[default-store/store/composables] useHasTableCell', () => {
  const Component = defineComponent({
    setup() {
      const hasTableCell = useHasTableCell('projects', 'name')
...
test('[default-store/store/composables] useHasTables', () => {
  const Component = defineComponent({
    setup() {
...
test('[default-store/store/composables] useHasValue', () => {
  const Component = defineComponent({
    setup() {
      const hasValue = useHasValue('currentUserId')
...
test('[default-store/store/composables] useHasValues', () => {
  const Component = defineComponent({
    setup() {
...
test('[default-store/store/composables] useRow', () => {
  const Component = defineComponent({
    setup() {
      const row = useRow('projects', 'p1')
...
test('[default-store/store/composables] useRowCount', () => {
  const Component = defineComponent({
    setup() {
      const rowCount = useRowCount('projects')
...
test('[default-store/store/composables] useRowIds', () => {
  const Component = defineComponent({
    setup() {
      const rowIds = useRowIds('projects')
...
test('[default-store/store/composables] useSortedRowIds', () => {
  const Component = defineComponent({
    setup() {
      const rowIds = useSortedRowIds('projects', 'name')
...
test('[default-store/store/composables] useTable', () => {
  const Component = defineComponent({
    setup() {
...
test('[default-store/store/composables] useTableCellIds', () => {
  const Component = defineComponent({
    setup() {
      const cellIds = useTableCellIds('projects')
...
test('[default-store/store/composables] useTableIds', () => {
  const Component = defineComponent({
    setup() {
...
test('[default-store/store/composables] useTables', () => {
  const Component = defineComponent({
    setup() {
...
test('[default-store/store/composables] useValue', () => {
  const Component = defineComponent({
    setup() {
      const value = useValue('currentUserId')
...
test('[default-store/store/composables] useValueIds', () => {
  const Component = defineComponent({
    setup() {
...
test('[default-store/store/composables] useValues', () => {
  const Component = defineComponent({
    setup() {
