...
test('[custom-store/store/references] cellRef', async () => {
  const Component = defineComponent({
    setup() {
      const value = cellRef(store, 'projects', 'p1', 'name')
...
test('[custom-store/store/references] rowRef', async () => {
  const Component = defineComponent({
    setup() {
      const value = rowRef(store, 'projects', 'p1')
...
test('[custom-store/store/references] tableRef', async () => {
  const Component = defineComponent({
    setup() {
      const value = tableRef(store, 'projects')
...
test('[custom-store/store/references] tablesRef', async () => {
  const Component = defineComponent({
    setup() {
      const value = tablesRef(store)
...
test('[custom-store/store/references] valueRef', async () => {
  const Component = defineComponent({
    setup() {
      const value = valueRef(store, 'theme')
...
test('[custom-store/store/references] valuesRef', async () => {
  const Component = defineComponent({
    setup() {
      const value = valuesRef(store)
